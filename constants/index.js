export const exploreWorlds = [
  {
    ...
    title: 'Notification',
    description:
      'The word "notification" refers to the app\'s primary function of sending alerts to students when exam results are released on the NIBM website.',
  },
  {
    id: 'world-2',
    ...
    title: 'INSPIRATION',
    description:
      'The word "inspiration" refers to the app\'s secondary function of motivating and inspiring students to strive for better marks by highlighting their progress and achievements.',
  },
  {
    id: 'world-3',
    ...
    title: ' BETTER MARKS',
    description:
      'The phrase "better marks" refers to the ultimate goal of the app, which is to help students achieve better results in their academic pursuits.',
  },
];
...
export const newFeatures = [
  ...
  },
  {
    ...
    title: 'More Faster',
    subtitle:
      'In the latest update, We make improvement to the app to make it more faster and more reliable',
  },
];
