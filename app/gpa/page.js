...
const Page = () => {
  ...
  return (
    <div className="container mx-auto my-8 relative z-10 text-center flex flex-col md:flex-row md:flex-wrap pb-12">
      <div className="flex flex-col md:flex-wrap w-full mx-auto">
      ...
      {loading && (
        <div className="mx-auto">
          ...
          <div role="status" className="mt-8 mx-auto flex flex-col justify-center text-center">
            <svg aria-hidden="true" className="w-8 h-8 mr-2 mx-auto text-gray-200 animate-spin dark:text-gray-600 fill-gray-600 dark:fill-gray-300" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
