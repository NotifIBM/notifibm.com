...
const Page = () => (
  <div className="mx-auto my-8 relative z-10 text-center flex flex-col md:flex-row md:flex-wrap pb-12">
    ...
    <div
      className="m-2 mx-12 p-5 text-center"
    >
      <section>
        <TypingText title="01. Introduction" textStyles="text-left  !text-xl !font-extrabold" />
        <div
          className="mt-[8px] font-normal sm:text-lg text-sm text-justify text-secondary-white pb-10"
        >
      ...
      <section>
        <TypingText title="02. Use of the Website" textStyles="text-left  !text-xl !font-extrabold" />
        <div
          className="mt-[8px] font-normal sm:text-lg text-sm text-justify text-secondary-white pb-10"
        >
      ...
      <section>
        <TypingText title="03. Disclaimer" textStyles="text-left  !text-xl !font-extrabold" />
        <div
          className="mt-[8px] font-normal sm:text-lg text-sm text-justify text-secondary-white pb-10"
        >
      ...
      <section>
        <TypingText title="04. Limitation of Liability" textStyles="text-left  !text-xl !font-extrabold" />
        <div
          className="mt-[8px] font-normal sm:text-lg text-sm text-justify text-secondary-white pb-10"
        >
      ...
      <section>
        <TypingText title="05. Indemnification" textStyles="text-left  !text-xl !font-extrabold" />
        <div
          className="mt-[8px] font-normal sm:text-lg text-sm text-justify text-secondary-white pb-10"
        >
      ...
      <section>
        <TypingText title="06. Modifications to the Website" textStyles="text-left  !text-xl !font-extrabold" />
        <div
          className="mt-[8px] font-normal sm:text-lg text-sm text-justify text-secondary-white pb-10"
        >
      ...
      <section>
        <TypingText title="07. Governing Law" textStyles="text-left  !text-xl !font-extrabold" />
        <div
          className="mt-[8px] font-normal sm:text-lg text-sm text-justify text-secondary-white pb-10"
        >
      ...
      <section>
        <TypingText title="08. Changes to Terms of Use" textStyles="text-left  !text-xl !font-extrabold" />
        <div
          className="mt-[8px] font-normal sm:text-lg text-sm text-justify text-secondary-white pb-10"
        >
      ...
      <section>
        <TypingText title="09. Termination" textStyles="text-left  !text-xl !font-extrabold" />
        <div
          className="mt-[8px] font-normal sm:text-lg text-sm text-justify text-secondary-white pb-10"
        >
      ...
      <section>
        <TypingText title="10. Entire Agreement" textStyles="text-left  !text-xl !font-extrabold" />
        <div
          className="mt-[8px] font-normal sm:text-lg text-sm text-justify text-secondary-white pb-10"
        >
      ...
      <section>
        <TypingText title="11. Contact Us" textStyles="text-left  !text-xl !font-extrabold" />
        <div
          className="mt-[8px] font-normal sm:text-lg text-sm text-justify text-secondary-white pb-10"
        >
          If you have any questions about these Terms of Use, please contact us at <a href="mailto:hi@notifibm.com" aria-label="Contact NotifIBM" className="font-mono hover:underline">hi@notifibm.com</a>.
        </div>
      </section>
